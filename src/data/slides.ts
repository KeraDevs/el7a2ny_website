export const enSlides = [
  {
    id: 1,
    imageUrl: "/images/car-repair1.jpg",
  ...
  {
    id: 2,
    imageUrl: "/images/emergency-car1.jpg",
  ...
  {
    id: 3,
    imageUrl: "/images/car-parts1.jpg",
  ...
  {
    id: 4,
    imageUrl: "/images/car-repair2.jpg",
...
export const arSlides = [
  {
    ...
    description:
      "ميكانيكيون خبراء وتكنولوجيا متطورة لجميع احتياجاتك في عالم السيارات. خدمة عالية الجودة يمكنك الوثوق بها.",
    ctaText: "احجز خدمة الآن",
    ctaLink: "/ar/services",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    description:
      "حوّل سيارتك مع التغليف والتخصيص الاحترافي. اجعل سيارتك فريدة من نوعها.",
    ctaText: "استكشف الخيارات",
